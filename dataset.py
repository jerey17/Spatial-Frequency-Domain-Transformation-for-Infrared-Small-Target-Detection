...
class TestSetLoader(Dataset):
    def __init__(self, dataset_dir, train_dataset_name, test_dataset_name,base_size, img_norm_cfg=None):
...
if __name__ == '__main__':
    train = TrainSetLoader('./dataset','IRSTD-1k',patch_size=256, img_norm_cfg=None)
    print(train[0][1].shape)

    test = TestSetLoader('./dataset',train_dataset_name='NUAA-SIRST',test_dataset_name='NUAA-SIRST',img_norm_cfg=None,base_size=256)
